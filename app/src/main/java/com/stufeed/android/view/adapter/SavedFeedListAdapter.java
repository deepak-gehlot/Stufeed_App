...
public class SavedFeedListAdapter extends RecyclerView.Adapter<SavedFeedListAdapter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        RowSavedFeedBinding rowBinding = DataBindingUtil.inflate(LayoutInflater.from(context), R.layout.row_saved_feed,
                parent,
                false);
     ...
     * @param post
     */
    private void rePost(GetSavedPostResponse.Post post) {
        Api api = APIClient.getClient().create(Api.class);
