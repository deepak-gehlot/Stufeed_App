...
public class UserFeedListAdapter extends RecyclerView.Adapter<UserFeedListAdapter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        RowUserFeedBinding rowBinding = DataBindingUtil.inflate(LayoutInflater.from(context), R.layout
                .row_user_feed, parent, false);
...
*/
    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        private RowUserFeedBinding rowBinding;

        private ViewHolder(RowUserFeedBinding rowBinding) {
